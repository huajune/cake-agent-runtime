...
| # | 项目 | 代码实况 | 状态 |
|---|---|---|---|
| 1 | 旧对照组下线（§15.6）| `legacyDetectBrandAliasHints`（high-confidence-facts.ts）、`legacyNicknameBrandMatch`（brand-state.service.ts）均在 | ❌ 门禁三条全不满足 |
...
### 18.1 旧对照组下线：门禁状态（2026-07-20 生产数据）
