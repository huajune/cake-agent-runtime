...
| 3 | `preferences.brands` 投影删除（Phase 4.4）| `applyBrandProjection` 仍在现算；3 个读方未迁 | ❌ 未完成 |
| 4 | 遗留决策点（§16、§17）| 3 项中 1 项已裁定（`category_default` 撤除），2 项开放 | ⚠️ 2 项开放 |
...
### 18.2 `preferences.brands` 投影：口径冲突待裁定

§15.6 与 §17 第 4 条**互相矛盾**，需择一：
