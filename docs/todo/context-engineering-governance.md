...
> **二期已立项（2026-08-21，讨论收敛后成文）**：[memory-coala-alignment.md](./memory-coala-alignment.md)——给 procedural 记忆层上户口（M1 分层供给 / M2 命名对齐搭车 / M3 事实·工作台分家）。执行等本方案 P3 证据批次收尾，或用户明示提前。
