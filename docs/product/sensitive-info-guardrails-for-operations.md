...
| 防群满/群解散编造          | `group_full_without_invite`                               | 输出前 | 📝          | P1     | agent-runtime | active | 历史已尝试拉群但本轮未重试需上下文豁免 | 同上                                                         |
| 防薪资编造                 | `salary_fabrication`                                      | 输出前 | 📝          | P1     | agent-runtime | active | 历史岗位复述为降误杀暂不检测           | 同上                                                         |
| 防收资模板漏字段           | `booking_form_field_mismatch`                             | 输出前 | 📝          | P1     | agent-runtime | active | 字段同义词仍需归一化补充               | 同上                                                         |
| 观测系统状态编造           | `system_status_fabrication`                               | 输出前 | 📡          | P1     | agent-runtime | active | 更委婉的甩锅话术需线上补样本           | 同上                                                         |
