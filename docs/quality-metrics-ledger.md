...
| 2026-09-22 | weekly-judge-calibration | onboard_followup | 判官精确率 | 1.0000 | 35        | 35          | J1 复聊 blockReason：35 次判决全对（send 15、skip 20 含归因）；3 次「已提醒过」把 T-2 触达算成已提醒、吞掉当天提醒，口径待人裁 | logs/analysis/judge-calibration-2026-09-22.md#C1 |
