...
| duliday_cancel_work_order                      | 2,000                                        | 取消契约                                      | 与 BK2 成对；2026-09-08：+「系统无工单≠无预约——真人带外约面/候选人指认具体已约面试时 request_handoff(modify_appointment)，禁说没有预约记录」（badcase a9jahy31） |
