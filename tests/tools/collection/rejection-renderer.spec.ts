...
describe('renderRejection · 可明说族', () => {
  ...
  it('年龄：要求描述只用契约的 min/max 造句，不外推', () => {
    ...
    const disqualified = proposeValue(form, AGE_18_40, {
      value: '55',
      sourceText,
      producer: 'candidate_quote',
      candidateTexts: [sourceText],
  ...
  it('分性别值域按候选人性别取那一档造句——说错档等于报错要求', () => {
    ...
    form = proposeValue(form, GENDER_MALE_ONLY, {
      value: '男',
      optionCodes: ['1'],
      sourceText: '我是男的',
      producer: 'candidate_quote',
    ...
    const disqualified = proposeValue(form, HEIGHT_GENDERED, {
      value: '150',
      sourceText: '我150',
      producer: 'candidate_quote',
      candidateTexts: ['我150'],
...
describe('renderRejection · 禁明说族', () => {
  ...
  it('未知新标签默认走禁明说档', () => {
    ...
    const form = proposeValue(createForm({ jobId: 1, contract }), unknownField, {
      value: '有',
      optionCodes: ['y'],
      sourceText,
      producer: 'candidate_quote',
