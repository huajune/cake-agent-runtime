import { adjudicateCandidateClaims } from '@memory/facts/candidate/candidate-fact-adjudicator';
import { pickAcceptedValues } from '@memory/facts/candidate/candidate-effective-profile';
import type { CandidateFactClaim } from '@memory/facts/candidate/candidate-fact-claim.types';
