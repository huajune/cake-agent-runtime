...
<<<<<<< HEAD:tests/biz/test-suite/repositories/conversation-snapshot.repository.spec.ts
...
>>>>>>> origin/master:src/biz/test-suite/repositories/conversation-snapshot.repository.spec.ts
