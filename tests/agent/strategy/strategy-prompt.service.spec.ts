...
import { StrategyPromptService } from '@agent/strategy-prompt.service';
...
describe('StrategyPromptService (agent layer)', () => {
  ...
  beforeEach(async () => {
    ...
    service = module.get<StrategyPromptService>(StrategyPromptService);
  });
