...
const FUNNEL_PALETTE = [
  { color: '#8f82d6', accent: '#b3a9e6' },
  { color: '#8fb2e0', accent: '#b9cff0' },
  { color: '#8cc9a1', accent: '#b4dfc0' },
  { color: '#e3a3bf', accent: '#f2c3d6' },
  { color: '#e2b98a', accent: '#f0d3b3' },
  { color: '#b3a9e6', accent: '#d2cbf0' },
];
