...
const DETAIL_REASON_LABELS: Record<string, string> = {
  ...
  interview_done_reported: '候选人已主动告知面试已完成、在等结果，且招募经理已回应过，不再重复追问',
  result_inquiry_already_sent: '招募经理在面试时间之后已经询问过本次面试结果',
  interview_reminder_already_sent: '面试当天招募经理已另行发过本次面试提醒',
  confirmation_already_sent: '报名成功之后招募经理已另行确认过候选人是否仍会参加面试，不重复确认',
  candidate_abandoned_onboarding: '候选人在聊天中已明确放弃入职，已停止触达',
  candidate_reported_onboarded: '候选人在聊天中已告知已经上岗，已停止触达',
  duplicate_of_recent_assistant_reply: '生成文案与招募经理最近一条消息重复，已拦截',
  candidate_name_in_reply: '生成文案里出现了候选人姓名，已拦截',
  ...
  interview_too_close: '提前 2 天确认档到点时距面试已不足 1 天，交给面试当天提醒，本次不发',
  signup_interview_gap_lt_3d: '报名到面试不足 3 天，不适用提前 2 天确认档，已跳过',
  dominated_by_booking_incomplete: '候选人已有待发的收资未完成复聊，报名前的低阶场景不再另排',
  work_order_regressed: '工单状态已不是面试成功及之后的状态，入职跟进不再继续',
  already_onboarded: '工单显示候选人已上岗，入职跟进静默结束',
  onboarding_intervention_dispatched: '工单显示上岗失败或已离职，已转运营跟进，候选人侧不再触达',
