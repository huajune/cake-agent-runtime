  ...
  const bookingChartOptions = {
    ...
    scales: {
      ...
      y1: {
        ...
        title: { display: true, text: '转化率 (%)', color: '#5fb894', font: { size: 10 } },
      },
    },
  };
    ...
    datasets: [
      {
        ...
        borderColor: '#6f9ce6',
        backgroundColor: 'rgba(111, 156, 230, 0.2)',
        fill: true,
        tension: 0.4,
        borderWidth: 3,
        pointRadius: 0,
