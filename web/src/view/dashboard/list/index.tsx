...
export default function Dashboard() {
  ...
  const commonOptions = {
    ...
    plugins: {
      ...
      tooltip: {
        ...
        titleColor: '#14132b',
        bodyColor: '#3b3a55',
        borderColor: 'rgba(138, 137, 173, 0.2)',
        borderWidth: 1,
        padding: 12,
        cornerRadius: 8,
        displayColors: false,
    ...
    scales: {
      ...
      y: {
        ...
        ticks: { color: '#8a89ad', font: { size: 11 }, padding: 10 },
      },
    },
    elements: {
  ...
  const bookingChartOptions = {
    ...
    plugins: {
      ...
      legend: { display: true, labels: { color: '#5b5a86', usePointStyle: true, boxWidth: 8 } },
    },
    scales: {
      ...
      y1: {
        ...
        title: { display: true, text: '转化率 (%)', color: '#5ec9a0', font: { size: 10 } },
      },
    },
  };
    ...
    datasets: [
      {
        ...
        backgroundColor: '#e8a64f',
        borderRadius: 6,
        hoverBackgroundColor: '#d4903a',
    ...
    datasets: [
      {
        ...
        borderColor: '#6ea3f5',
        backgroundColor: 'rgba(110, 163, 245, 0.2)',
        fill: true,
        tension: 0.4,
        borderWidth: 3,
        pointRadius: 0,
