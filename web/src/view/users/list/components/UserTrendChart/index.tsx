        ...
        <div className={styles.chartWrapper}>
          ...
          <div className={styles.statsCards}>
            <div className={`${styles.statCard} ${styles.cardPrimary}`}>
              ...
              <div className={styles.statInfo}>
                ...
                <div className={styles.statValue}>
                  {totalUserOccurrences} <span className={styles.unit}>人次</span>
                </div>
              </div>
            </div>
            <div className={`${styles.statCard} ${styles.cardSecondary}`}>
              <div
                className={styles.statIcon}
                style={{ background: 'linear-gradient(135deg, #f093fb 0%, #e07a9a 100%)' }}
              >
              ...
              <div className={styles.statInfo}>
                ...
                <div className={styles.statValue}>
                  {totalMessages} <span className={styles.unit}>条</span>
                </div>
              </div>
            </div>
            <div className={`${styles.statCard} ${styles.cardAccent}`}>
              ...
              <div className={styles.statInfo}>
                ...
                <div className={styles.statValue}>
                  {maxUsers} <span className={styles.unit}>人</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.dataNote}>
            ...
            <span>
              趋势图已剔除周六、周日；用户数按当日托管独立用户统计，累计托管人次为各日用户数求和，跨天会重复计数；消息数按用户实际发送条数统计。
            </span>
          </div>
              ...
              {metricBoards.map((board) => (
                <div className={styles.chartBoard} key={board.dataKey}>
                  ...
                  <div className={styles.boardStats}>
                    <span>
                      {selectedRange.totalLabel} <strong>{board.total}</strong>
                      {board.totalUnit || board.unit}
                    </span>
                    <span>
                      日均 <strong>{board.average}</strong>
                      {board.unit}
                    </span>
                  </div>
                    ...
                    <ResponsiveContainer width="100%" height={260}>
                      ...
                      >
                        ...
                        <Tooltip
                          ...
                          formatter={(value) => [
                            `${formatLocaleNumber(Number(value))} ${board.unit}`,
                            board.dataKey,
                          ]}
