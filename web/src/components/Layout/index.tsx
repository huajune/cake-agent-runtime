        ...
        <>
          ...
          <defs>
            ...
            <radialGradient id="bloomCenter" cx="50%" cy="50%">
              ...
              <stop offset="60%" stopColor="#efc27a" />
              <stop offset="100%" stopColor="#efc27a" />
            </radialGradient>
          </defs>
          {/* 主枝 */}
          <path d="M0 5 Q30 8 60 20 Q90 35 120 30 Q135 28 145 35" stroke="#a8dcc4" strokeWidth="3" fill="none" />
          {/* 分枝 */}
          <path d="M40 14 Q45 30 38 45" stroke="#a8dcc4" strokeWidth="2" fill="none" />
          <path d="M80 28 Q85 45 78 58" stroke="#a8dcc4" strokeWidth="2" fill="none" />
          <path d="M110 30 Q118 18 125 12" stroke="#a8dcc4" strokeWidth="2" fill="none" />
          {/* 花朵1 */}
          ...
          <path d="M143 34 Q145 30 147 34" stroke="#a8dcc4" strokeWidth="1.2" fill="#a8dcc4" />
          <ellipse cx="100" cy="32" rx="2.5" ry="3.5" fill="#f5c6da" />
          {/* 叶子 */}
          <ellipse cx="25" cy="12" rx="4" ry="8" fill="#a8dcc4" transform="rotate(60, 25, 12)" opacity="0.7" />
          <ellipse cx="50" cy="22" rx="3" ry="6" fill="#a8dcc4" transform="rotate(40, 50, 22)" opacity="0.6" />
          <ellipse cx="95" cy="38" rx="3" ry="6" fill="#a8dcc4" transform="rotate(-20, 95, 38)" opacity="0.7" />
          {/* 飘落花瓣 */}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', animation: 'swing 3.2s ease-in-out infinite', transformOrigin: 'top center' }}>
            <div style={{ width: '1.5px', height: '10px', background: '#a8dcc4' }} />
            <svg width="28" height="50" viewBox="0 0 30 55" fill="none">
              <path d="M15 0 Q13 15 16 30 Q14 42 15 52" stroke="#a8dcc4" strokeWidth="2" fill="none" />
              <ellipse cx="8" cy="12" rx="5" ry="8" fill="#a8dcc4" transform="rotate(-30, 8, 12)" opacity="0.8" />
              <ellipse cx="22" cy="24" rx="5" ry="8" fill="#a8dcc4" transform="rotate(25, 22, 24)" opacity="0.7" />
              <ellipse cx="9" cy="38" rx="4" ry="7" fill="#a8dcc4" transform="rotate(-20, 9, 38)" opacity="0.75" />
            </svg>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', animation: 'swing 3s ease-in-out infinite', transformOrigin: 'top center' }}>
            <div style={{ width: '1.5px', height: '14px', background: 'linear-gradient(180deg, #a8dcc4, #f5c6da)' }} />
            <svg width="40" height="44" viewBox="0 0 44 48" fill="none">
              <path d="M22 0 Q20 12 24 24" stroke="#a8dcc4" strokeWidth="2" fill="none" />
              <ellipse cx="16" cy="10" rx="4" ry="7" fill="#a8dcc4" transform="rotate(-25, 16, 10)" opacity="0.8" />
              <ellipse cx="30" cy="16" rx="3.5" ry="6" fill="#a8dcc4" transform="rotate(20, 30, 16)" opacity="0.7" />
              <g transform="translate(22, 30)">
                {[0, 72, 144, 216, 288].map((r) => (
                  <ellipse key={r} cx="0" cy="-7" rx="4.5" ry="8" fill="#f5c6da" transform={`rotate(${r})`} opacity="0.9" />
                ))}
                <circle cx="0" cy="0" r="3.5" fill="#efc27a" />
              </g>
            </svg>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', animation: 'butterflyFloat 3.5s ease-in-out infinite', animationDelay: '1s', transformOrigin: 'top center' }}>
            <div style={{ width: '1.5px', height: '12px', background: '#a8dcc4' }} />
            <svg width="44" height="38" viewBox="0 0 48 40" fill="none">
              <path d="M10 36 Q24 34 38 36" stroke="#a8dcc4" strokeWidth="2.5" fill="none" />
              <ellipse cx="8" cy="32" rx="3" ry="5" fill="#a8dcc4" transform="rotate(-40, 8, 32)" opacity="0.8" />
              <ellipse cx="40" cy="32" rx="3" ry="5" fill="#a8dcc4" transform="rotate(40, 40, 32)" opacity="0.7" />
              <ellipse cx="24" cy="24" rx="8" ry="6" fill="#d19a52" />
              <circle cx="30" cy="18" r="5" fill="#efc27a" />
              <circle cx="32" cy="17" r="1.2" fill="#14132b" />
              <circle cx="32.3" cy="16.7" r="0.4" fill="#FFF" />
              <path d="M35 18 L39 19 L35 20Z" fill="#d19a52" />
              <path d="M18 21 Q12 14 9 17 Q12 22 18 24Z" fill="#efc27a" opacity="0.9">
                <animateTransform attributeName="transform" type="rotate" values="0 18 22;-12 18 22;0 18 22" dur="0.8s" repeatCount="indefinite" />
              </path>
              <path d="M16 24 Q10 26 8 30" stroke="#d19a52" strokeWidth="1.5" fill="none" />
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', animation: 'swing 2.8s ease-in-out infinite', animationDelay: '0.3s', transformOrigin: 'top center' }}>
            <div style={{ width: '1.5px', height: '20px', background: 'linear-gradient(180deg, #a8dcc4, #f5c6da)' }} />
            <svg width="38" height="42" viewBox="0 0 40 46" fill="none">
              <path d="M20 0 Q18 14 22 28" stroke="#a8dcc4" strokeWidth="2" fill="none" />
              <ellipse cx="14" cy="8" rx="4" ry="7" fill="#a8dcc4" transform="rotate(-30, 14, 8)" opacity="0.75" />
              <ellipse cx="28" cy="18" rx="3.5" ry="6.5" fill="#a8dcc4" transform="rotate(25, 28, 18)" opacity="0.8" />
              <g transform="translate(20, 34)">
                {[0, 72, 144, 216, 288].map((r) => (
                  <ellipse key={r} cx="0" cy="-6" rx="4" ry="7" fill="#f5c6da" transform={`rotate(${r})`} opacity="0.85" />
                ))}
                <circle cx="0" cy="0" r="3" fill="#efc27a" />
              </g>
            </svg>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', animation: 'swing 3.5s ease-in-out infinite', animationDelay: '0.8s', transformOrigin: 'top center' }}>
            <div style={{ width: '1.5px', height: '16px', background: '#a8dcc4' }} />
            <svg width="26" height="44" viewBox="0 0 28 48" fill="none">
              <path d="M14 0 Q12 16 14 32 Q13 40 14 46" stroke="#a8dcc4" strokeWidth="2" fill="none" />
              <ellipse cx="7" cy="10" rx="5" ry="8" fill="#5fb894" transform="rotate(-35, 7, 10)" opacity="0.7" />
              <ellipse cx="21" cy="22" rx="4.5" ry="7" fill="#6EE7B7" transform="rotate(30, 21, 22)" opacity="0.75" />
              <ellipse cx="8" cy="34" rx="4" ry="6.5" fill="#a8dcc4" transform="rotate(-25, 8, 34)" opacity="0.7" />
