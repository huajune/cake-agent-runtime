        ...
        <>
          ...
          <defs>
            <radialGradient id="bloomL" cx="50%" cy="50%">
              <stop offset="0%" stopColor="#faf1f4" />
              <stop offset="50%" stopColor="#edd1d8" />
              <stop offset="100%" stopColor="#edd1d8" />
            </radialGradient>
            <radialGradient id="bloomCenter" cx="50%" cy="50%">
              <stop offset="0%" stopColor="#FFF" />
              <stop offset="60%" stopColor="#f5c878" />
              <stop offset="100%" stopColor="#f5c878" />
            </radialGradient>
          </defs>
          {/* 主枝 */}
          <path d="M0 5 Q30 8 60 20 Q90 35 120 30 Q135 28 145 35" stroke="#a6e6cc" strokeWidth="3" fill="none" />
          {/* 分枝 */}
          <path d="M40 14 Q45 30 38 45" stroke="#a6e6cc" strokeWidth="2" fill="none" />
          <path d="M80 28 Q85 45 78 58" stroke="#a6e6cc" strokeWidth="2" fill="none" />
          <path d="M110 30 Q118 18 125 12" stroke="#a6e6cc" strokeWidth="2" fill="none" />
          {/* 花朵1 */}
          ...
          {/* 花苞 */}
          <ellipse cx="145" cy="38" rx="3" ry="4.5" fill="#edd1d8" />
          <path d="M143 34 Q145 30 147 34" stroke="#a6e6cc" strokeWidth="1.2" fill="#a6e6cc" />
          <ellipse cx="100" cy="32" rx="2.5" ry="3.5" fill="#edd1d8" />
          {/* 叶子 */}
          ...
          {/* 飘落花瓣 */}
          <ellipse cx="55" cy="75" rx="3" ry="2" fill="#edd1d8" opacity="0.6" transform="rotate(-30, 55, 75)">
          ...
          <ellipse cx="90" cy="80" rx="2.5" ry="1.8" fill="#edd1d8" opacity="0.5" transform="rotate(20, 90, 80)">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', animation: 'swing 3.2s ease-in-out infinite', transformOrigin: 'top center' }}>
            <div style={{ width: '1.5px', height: '10px', background: '#a6e6cc' }} />
            <svg width="28" height="50" viewBox="0 0 30 55" fill="none">
              <path d="M15 0 Q13 15 16 30 Q14 42 15 52" stroke="#a6e6cc" strokeWidth="2" fill="none" />
              <ellipse cx="8" cy="12" rx="5" ry="8" fill="#a6e6cc" transform="rotate(-30, 8, 12)" opacity="0.8" />
              <ellipse cx="22" cy="24" rx="5" ry="8" fill="#a6e6cc" transform="rotate(25, 22, 24)" opacity="0.7" />
              <ellipse cx="9" cy="38" rx="4" ry="7" fill="#a6e6cc" transform="rotate(-20, 9, 38)" opacity="0.75" />
            </svg>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', animation: 'swing 3s ease-in-out infinite', transformOrigin: 'top center' }}>
            <div style={{ width: '1.5px', height: '14px', background: 'linear-gradient(180deg, #a6e6cc, #edd1d8)' }} />
            <svg width="40" height="44" viewBox="0 0 44 48" fill="none">
              ...
              <g transform="translate(22, 30)">
                {[0, 72, 144, 216, 288].map((r) => (
                  <ellipse key={r} cx="0" cy="-7" rx="4.5" ry="8" fill="#edd1d8" transform={`rotate(${r})`} opacity="0.9" />
                ))}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', animation: 'butterflyFloat 4s ease-in-out infinite', transformOrigin: 'top center' }}>
            ...
            <svg width="42" height="36" viewBox="0 0 36 30" fill="none">
              <path d="M18 15 Q8 4 4 10 Q2 18 12 19 Q14 19 18 15Z" fill="#b9a6ff" opacity="0.85">
              ...
              <path d="M18 15 Q12 22 10 25 Q14 28 18 22Z" fill="#b9a6ff" opacity="0.6" />
              ...
              <circle cx="12" cy="4" r="1" fill="#b9a6ff" />
              <circle cx="24" cy="4" r="1" fill="#b9a6ff" />
            </svg>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', animation: 'butterflyFloat 3.5s ease-in-out infinite', animationDelay: '1s', transformOrigin: 'top center' }}>
            <div style={{ width: '1.5px', height: '12px', background: '#a6e6cc' }} />
            <svg width="44" height="38" viewBox="0 0 48 40" fill="none">
              <path d="M10 36 Q24 34 38 36" stroke="#a6e6cc" strokeWidth="2.5" fill="none" />
              <ellipse cx="8" cy="32" rx="3" ry="5" fill="#a6e6cc" transform="rotate(-40, 8, 32)" opacity="0.8" />
              <ellipse cx="40" cy="32" rx="3" ry="5" fill="#a6e6cc" transform="rotate(40, 40, 32)" opacity="0.7" />
              <ellipse cx="24" cy="24" rx="8" ry="6" fill="#e8a64f" />
              <circle cx="30" cy="18" r="5" fill="#f5c878" />
              <circle cx="32" cy="17" r="1.2" fill="#14132b" />
              <circle cx="32.3" cy="16.7" r="0.4" fill="#FFF" />
              <path d="M35 18 L39 19 L35 20Z" fill="#e8a64f" />
              <path d="M18 21 Q12 14 9 17 Q12 22 18 24Z" fill="#f5c878" opacity="0.9">
              ...
              <circle cx="28" cy="20" r="1.5" fill="#edd1d8" opacity="0.5" />
            </svg>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', animation: 'swing 2.8s ease-in-out infinite', animationDelay: '0.3s', transformOrigin: 'top center' }}>
            <div style={{ width: '1.5px', height: '20px', background: 'linear-gradient(180deg, #a6e6cc, #edd1d8)' }} />
            <svg width="38" height="42" viewBox="0 0 40 46" fill="none">
              ...
              <g transform="translate(20, 34)">
                {[0, 72, 144, 216, 288].map((r) => (
                  <ellipse key={r} cx="0" cy="-6" rx="4" ry="7" fill="#edd1d8" transform={`rotate(${r})`} opacity="0.85" />
                ))}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', animation: 'swing 3.5s ease-in-out infinite', animationDelay: '0.8s', transformOrigin: 'top center' }}>
            <div style={{ width: '1.5px', height: '16px', background: '#a6e6cc' }} />
            <svg width="26" height="44" viewBox="0 0 28 48" fill="none">
              <path d="M14 0 Q12 16 14 32 Q13 40 14 46" stroke="#a6e6cc" strokeWidth="2" fill="none" />
              ...
              <ellipse cx="14" cy="45" rx="3" ry="3.5" fill="#edd1d8" opacity="0.8" />
            </svg>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', animation: 'butterflyFloat 4.5s ease-in-out infinite', animationDelay: '1.5s', transformOrigin: 'top center' }}>
            <div style={{ width: '1px', height: '18px', background: '#edd1d8' }} />
            <svg width="38" height="32" viewBox="0 0 36 30" fill="none">
              <path d="M18 15 Q8 3 4 10 Q2 18 12 19 Q14 19 18 15Z" fill="#edd1d8" opacity="0.85">
                <animateTransform attributeName="transform" type="rotate" values="-5 18 15;12 18 15;-5 18 15" dur="0.5s" repeatCount="indefinite" />
              </path>
              <path d="M18 15 Q28 3 32 10 Q34 18 24 19 Q22 19 18 15Z" fill="#edd1d8" opacity="0.85">
                <animateTransform attributeName="transform" type="rotate" values="5 18 15;-12 18 15;5 18 15" dur="0.5s" repeatCount="indefinite" />
              </path>
              <path d="M18 15 Q12 22 10 25 Q14 28 18 22Z" fill="#edd1d8" opacity="0.6" />
              <path d="M18 15 Q24 22 26 25 Q22 28 18 22Z" fill="#edd1d8" opacity="0.6" />
              <ellipse cx="18" cy="17" rx="1.5" ry="5.5" fill="#dfa4bb" />
              <path d="M17 12 Q14 5 12 3" stroke="#dfa4bb" strokeWidth="0.7" fill="none" />
              <path d="M19 12 Q22 5 24 3" stroke="#dfa4bb" strokeWidth="0.7" fill="none" />
              <circle cx="12" cy="3" r="0.8" fill="#dfa4bb" />
              <circle cx="24" cy="3" r="0.8" fill="#dfa4bb" />
            </svg>
          </div>
            </div>
          ...
          <defs>
            <radialGradient id="bloomR" cx="50%" cy="50%">
              <stop offset="0%" stopColor="#FFF" />
              <stop offset="50%" stopColor="#edd1d8" />
              <stop offset="100%" stopColor="#dfa4bb" />
            </radialGradient>
          </defs>
          {/* 主枝 */}
          <path d="M0 5 Q30 8 60 20 Q90 35 120 30 Q135 28 145 35" stroke="#a6e6cc" strokeWidth="3" fill="none" />
