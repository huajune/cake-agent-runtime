...
BEGIN
  ...
  SELECT
    ...
    ROUND(COALESCE(AVG(b.ai_duration) FILTER (WHERE b.status = 'success' AND b.ai_duration > 0), 0))::numeric AS avg_ai_duration,
    ROUND(COALESCE(AVG(b.send_duration) FILTER (WHERE b.status = 'success' AND b.send_duration > 0), 0))::numeric AS avg_send_duration,
