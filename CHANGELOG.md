...
Bug 修复：
- ci: sync release updates to develop via PR (#55) (e123077)
- address PR review — add tool test, validate inputs, cap image cache (a3ca961)
- update strategy tests for versioning refactor (4b0cd1b)
- prevent duplicate group task execution (227f3f6)
- sync develop before release tagging (281558f)
...
- add invite-to-group product design and minor fixes (bb167a9)
- add strategy config versioning and environment isolation (fcd578a)
...
- remove hardcoded strategy seed data (b18bc2d)
...
- add environment-specific db migration commands (e55f893)
...
- 发个版本试一下 (#61) (976a209)
- sync master release 4.0.0 into develop to unblock PR #56 (#57) (999d586)
- remove debug logs and clarify debug booking defaults (fa7afd6)
- add missing specs and move booking detection to biz layer (83d3d0e)
- refine feishu booking card and switch to @all (292e936)
- fix booking requirements and notify feishu in debug flows (7186a44)
- refactor agent memory pipeline and harden job lookup guards (6425b17)
