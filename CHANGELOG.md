...
### 更新摘要
- PR #1244 零工具轮模拟工具往返的判据拓宽 + booking 在途工单按焦点岗位对账
- PR #1244 出站守卫规则化重组 + Runner 三态 outcom…
- PR #1244 回合收尾/复聊/图片描述三条旁路补齐 trace 上下文 + debug-chat 错误事件入上下文
- PR #1244 群成员缓存预热加等待上限 + 回合装配对未核验群状态显式降级
- PR #1244 补 wecom-trace-timing 折算的行为测试
...
- PR #1244 出站守卫规则化重组 + Runner 三态 outcome + 品牌提及溯源 + 转化分析 RPC 下沉
