...
const SENSITIVE_ATTRIBUTE =
  '(?:户籍|户口|籍贯|本地人|少数民族|维吾尔族|哈萨克族|蒙古族|朝鲜族|婚育|婚姻|已婚|未婚|已育|未育|备孕|纹身|文身|刺青|[^，。；！？?\\n]{1,8}专业)';
...
const ORIGIN_PROBE_PATTERN =
  /(?:老家|籍贯|户籍|户口)[^。！？?\n]{0,6}(?:是)?(?:哪|什么地方|何处)|(?:哪里人|哪儿人|哪边人|哪个省的人|什么地方的人)|本地人(?:吗|吧|么|呢|\?|？)|(?:有没有|有无|是否有|有)(?:纹身|文身|刺青)(?:吗|吧|么|呢|呀|\?|？)|(?:纹身|文身|刺青)[^。！？?\n]{0,6}(?:在哪|多大|能遮|遮得住|遮不遮|什么位置|哪个位置)/u;
