...
// 否定前缀词表。「附近暂时没有日结岗位」和「不支持日结或周结」是否定陈述，
// 不能因出现结算词就当成肯定断言。
...
// 「后面有周结/日结的新岗位再通知你」或介绍其他灵工单时，不是在声称焦点岗位的结算周期。
...
// 假阳 ×2（`…_1785472764565`"关于日结的问题…所以结算方式暂时也没法确认"
...
function sentenceAssertsCycle(rawSentence: string, cycle: SettlementCycle): boolean {
  ...
  // （假阳 `…_1785400091574`"肯德基的日结兼职在你附近暂时没找到在招的"
  ...
  // 距否定词 7 字超出旧窗口，alternation 后段照旧假阳，）。基础间隔
