 ...
 * 不豁免会误伤资格提问（"需要提供劳动合同和社保证明，你有交本地社保的工作吗"）。
 *
 * 豁免必须锚定在"提供/出示 + 证明材料"的动宾结构或"你有交社保吗"的资格提问上，不能用
 * "合同/证明/材料"裸词："签合同交五险一金"是最常见的主动福利承诺组合，裸词豁免会把这条
 * P0 规则要拦的典型场景整句放行。
 */
// 岗位要求行常是名词短语式（"需第一职业劳动合同及社保""要求有本地社保和劳动合同"），
// 没有"提供/出示"动词也没有"证明"字样，动宾锚接不住，第二职业类岗位的推荐会被 P0 拦死。
// 故补三个锚：
 ...
 * 原 claim-assertion.util 共享原语；该 util 随 job-fact/booking 规则族下线后
