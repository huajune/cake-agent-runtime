    ...
    if (booking) {
      const lines = [
        booking.alreadyBooked
          ? '- 报名：该岗位已有在途预约，预约已经存在，本轮未重复提交——这不是失败，不得说没提交成功/系统问题/稍后再提交'
