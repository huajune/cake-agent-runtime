...
import { SendMessageType } from '@enums/send-message.enum';

export { SendMessageType } from '@enums/send-message.enum';

/**
 * @deprecated 请使用 SendMessageType 代替
 * 保留此别名以兼容旧代码
 */
export const MessageType = SendMessageType;
...
export class SendMessageDto {
  ...
  @IsNumber()
  @IsNotEmpty()
  messageType: SendMessageType; // 消息类型（1-14）
