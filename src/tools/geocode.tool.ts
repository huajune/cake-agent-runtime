...
**带专名前缀的车站不算黑名单**：有具体站名的车站，
按上面第 2 条正常处理——有高置信通识就填 city，没把握就留空，
...
const inputSchema = z.object({
  ...
  city: z
    ...
    .describe(
      '城市级名称。可选：' +
        '系统已明示城市 / 你对地名→城市映射有高置信通识时填入（含带专名前缀的车站）；' +
