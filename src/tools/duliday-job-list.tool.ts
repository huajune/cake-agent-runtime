...
type BrandSummaryJobInput = {
  basicInfo?: {
    ...
    jobId?: unknown;
    storeName?: unknown;
    storeInfo?: { storeName?: unknown } | null;
  } | null;
  _distanceKm?: unknown;
  jobSalary?: unknown;
};
...
- **工作班次时间必须主动展示**：本轮要做具体岗位推荐时，每条岗位都必须带上**具体上班时间段**（如"早班 7:30-9:30 / 中班 11:30-14:30"、"上班时间 09:00-18:00"），不得只用"早班/晚班/开档/前厅/后厨"等岗位名或时段名替代，也不得把"面试时间"误当成"上班班次"。**严禁**反问"距离和班次能不能接受？""你看这班次方便吗？"自己却没把班次时间说出来——badcase izoyiy16/9c49atl7/tkozzsp1 三连均为此类违规。工具返回的工作时间字段缺失/为空时，必须如实告知"班次门店再确认"，不得编造
