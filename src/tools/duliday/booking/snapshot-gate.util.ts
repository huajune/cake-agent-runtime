import type { CandidateClaimField } from '@memory/facts/candidate/candidate-fact-claim.types';
import { candidateValuesEquivalent } from '@memory/facts/candidate/candidate-fact-normalizers';
