...
export function formatJobsToMarkdown(
  ...
  md +=
    ...
    '福利备注里出现的"暑假工/寒假工薪资 X 元/时"只是该岗位的一档**薪资条件**，**不代表该岗位的用工类型是暑假工/寒假工**——' +
    '门店几乎从不把岗位标成暑假工/寒假工（岗位轴只有 全职/兼职 及细分）。' +
    '因此**不得据此向候选人宣称"这是暑假工岗位"或"有暑假工岗位在招"**；' +
    '面向找暑假工/寒假工的候选人时，如实说明这是兼职/短班岗位（可顺带提该季节性薪资条件），由候选人自行判断。\n\n';
