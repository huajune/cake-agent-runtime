...
export const WeworkSessionStateSchema = z.object({
  ...
  lastCandidatePool: SessionWorkbenchStateSchema.shape.lastCandidatePool,
  presentedJobs: SessionWorkbenchStateSchema.shape.presentedJobs,
  storePresentationRounds: SessionWorkbenchStateSchema.shape.storePresentationRounds,
  currentFocusJob: SessionWorkbenchStateSchema.shape.currentFocusJob,
