...
// 平台同时有全职和兼职岗位，用工形式是筛选维度。提取合法用工形式作为高置信偏好。
// 顺序敏感：长词/含子串的词必须在前（"兼职+" 先于 "兼职"，否则被 "兼职" 截胡）。
// "正式工"/"临时工" 与全职/兼职不同轴，不在招聘范围，不纳入提取。
const LABOR_FORM_KEYWORDS = ['兼职+', '暑假工', '寒假工', '小时工', '全职', '兼职'] as const;
