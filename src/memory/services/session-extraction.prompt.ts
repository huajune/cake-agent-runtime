...
- position: 意向岗位（如："服务员"、"收银员"）
  注意区分**品类/行业词**与**工种**：候选人说"咖啡""奶茶""火锅"等是**品类/行业**，**不要据此推断具体工种**。当前业务规则下，未点名品牌的"咖啡兼职/咖啡店岗位"默认 brands 为 M Stand；若明确说"其他咖啡品牌/除了 M Stand"则不得锁回 M Stand。"咖啡兼职"不要提取为 position "咖啡师"，除非候选人明确说"我想做咖啡师/想当咖啡师"
