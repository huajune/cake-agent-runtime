 ...
 * 候选人「社保缴纳情况」自陈的唯一识别器。
 *
 * 为什么需要它（badcase batch_6a8fec04ce406a6aee03d65f_*，2026-08-27）：该字段的
 * 契约选项是「本人缴纳本地社保 / 无公司在缴社保流水 / 公司缴纳外地社保…」这类系统
 * 措辞，而候选人的自然答案是「无」「没有」「没交过」——optionLabel 逐字直配永远配不上，
 * 槽位收不到值，两问配额烧完即熔断转人工。生产实测三天内该字段仅 1 次成功落格，
 * 且是候选人恰好复述了系统措辞。
 *
 * 判定边界（刻意窄）：
